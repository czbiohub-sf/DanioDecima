...
#SBATCH --output=/hpc/scratch/group.data.science/mathias.voges/zebrahub-decima/experiments/logs/decima_predict_%A_%a.out
#SBATCH --error=/hpc/scratch/group.data.science/mathias.voges/zebrahub-decima/experiments/logs/decima_predict_%A_%a.err
...
python /hpc/mydata/mathias.voges/Projects/research/seq2fun/step/decima-main/scripts/decima_predictions.py \
